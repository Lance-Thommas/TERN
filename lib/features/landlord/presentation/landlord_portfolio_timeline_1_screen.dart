...
const _llAmber = Color(0xFFE5A020);
      ...
      appBar: AppBar(
        ...
        actions: const [
          ...
          Padding(
            ...
            child: Text('LPT1', style: TextStyle(fontWeight: FontWeight.w700)),
          ),
        ],
        leading: IconButton(
      ...
      body: ListView(
        ...
        children: [
          ...
          _PropertyCard(
            ...
            statusColor: _llAmber,
            banner: 'Month adjusted. Rent continuity held.',
            progress: 0.65,
