  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Lease Closure Landlord'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: const Column(
          ...
          children: [
            SizedBox(height: 8),
            Text('Lease Closure Landlord', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
            SizedBox(height: 12),
            Text('Refer to design: lease_closure_landlord'),
            SizedBox(height: 12),
