...
class TenancyHistoryLandlordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tenancy History Landlord'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: const Column(
          ...
          children: [
            SizedBox(height: 8),
            Text('Tenancy History Landlord', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
            SizedBox(height: 12),
            Text('Refer to design: tenancy_history_landlord'),
            SizedBox(height: 12),
