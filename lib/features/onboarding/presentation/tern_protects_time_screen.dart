...
class TernProtectsTimeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tern Protects Time'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: const Column(
          ...
          children: [
            SizedBox(height: 8),
            Text('Tern Protects Time', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
            SizedBox(height: 12),
            Text('Refer to design: tern_protects_time'),
            SizedBox(height: 12),
