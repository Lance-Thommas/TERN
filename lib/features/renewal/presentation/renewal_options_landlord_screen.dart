  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Renewal Options Landlord'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: const Column(
          ...
          children: [
            SizedBox(height: 8),
            Text('Renewal Options Landlord', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
            SizedBox(height: 12),
            Text('Refer to design: renewal_options_landlord'),
            SizedBox(height: 12),
