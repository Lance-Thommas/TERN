...
const _renewBg = Color(0xFFF8F7F6);
const _renewPrimary = Color(0xFFE5A01F);

class RenewalWindowDecision1Screen extends StatelessWidget {
  const RenewalWindowDecision1Screen({super.key});

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Scaffold(
      backgroundColor: _renewBg,
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: Text('RWD1', style: const TextStyle(fontWeight: FontWeight.w700)),
          ),
        ],
        leading: IconButton(
                ...
                children: [
                  ShaderMask(
                    shaderCallback: (bounds) => const LinearGradient(
                      colors: [_renewPrimary, Color(0xFFB37D18)],
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  TextButton.icon(
                    onPressed: () {},
                    icon: const Icon(Icons.open_in_new, color: _renewPrimary, size: 18),
                    label: const Text('Need help deciding?', style: TextStyle(color: _renewPrimary, fontWeight: FontWeight.w700)),
                  ),
                ],
              ),
            ),
        ...
        Positioned.fill(
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(colors: [_renewPrimary, Color(0xFFE5A01F)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                    ...
                    Row(
                      children: [
                        Container(
                          width: 36,
                          height: 36,
                          decoration: BoxDecoration(color: _renewPrimary.withValues(alpha: 0.15), shape: BoxShape.circle),
                          child: const Icon(Icons.verified, color: _renewPrimary, size: 20),
                        ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          shadowColor: _renewPrimary.withValues(alpha: 0.3),
                          elevation: 6,
                        ),
