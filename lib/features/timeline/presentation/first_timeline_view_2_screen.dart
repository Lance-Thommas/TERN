  ...
  Widget build(BuildContext context) {
    ...
    final entries = <_TimelineEntry>[
      ...
      const _TimelineEntry(
        ...
        title: 'S1: Lease Active',
        subtitle: 'On Track',
        status: _TimelineStatus.current,
        pill: 'Today',
        highlight: true,
      ),
      const _TimelineEntry(icon: Icons.schedule, title: 'Next Rent Window', subtitle: 'Due in 12 days', status: _TimelineStatus.future),
      ...
      appBar: AppBar(
        ...
        actions: const [
          ...
          Padding(
            ...
            child: Text('FTV2', style: TextStyle(fontWeight: FontWeight.w700)),
          ),
        ],
        leading: IconButton(
          ...
          child: Column(
            ...
            children: [
              ...
              _HeroSection(
                ...
                subtitle: 'You are covered until Dec 31, 2023.',
                primary: primary,
              ),
              const SizedBox(height: 20),
              _ProgressSection(label: 'Annual Progress', valueLabel: '120 Days Elapsed', progress: 0.35, primary: primary),
...
class _TimelineItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (entry.icon == Icons.radio_button_checked) {
