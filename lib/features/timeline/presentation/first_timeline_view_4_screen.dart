  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('First Timeline View 4'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: const Column(
          ...
          children: [
            SizedBox(height: 8),
            Text('First Timeline View 4', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
            SizedBox(height: 12),
            Text('Refer to design: first_timeline_view_4'),
            SizedBox(height: 12),
